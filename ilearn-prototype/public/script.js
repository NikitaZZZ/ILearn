                    ...
                    <div class="list-group">
                        <a href="itests.html" target="_blank" style="cursor: pointer;" class="list-group-item list-group-item-action" aria-current="true">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">
                                    <img alt="icon" src="pizap.png" style="border-radius: 20px; width: 30px; height: 30px;" class="d-inline-block align-text-top">
                                    ITests
                                </h5>
                        ...
                        <a data-bs-toggle="modal" data-bs-target="#todo" style="cursor: pointer" class="list-group-item list-group-item-action">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">
                                    <img alt="icon" src="bg.png" style="border-radius: 20px; width: 30px; height: 30px;" class="d-inline-block align-text-top">
                                    To Do List
                                </h5>
                                <small class="text-muted">Открыть</small>
                            </div>
                        ...
                        <a data-bs-toggle="modal" data-bs-target="#chat" style="cursor: pointer" class="list-group-item list-group-item-action">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">
                                    <img alt="icon" src="lar_black.png" style="width: 30px; height: 30px;" class="d-inline-block align-text-top">
                                    LAR Chat
                                </h5>
                                <small class="text-muted">Открыть</small>
                            </div>
